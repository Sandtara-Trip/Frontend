...
import { contentData } from "../../templates/contentDataWisata";
import { imagesDetailWisata } from "../../templates/imagesDetailWisata";
    ...
    <>
      ...
      <div className="bg-base max-w-5xl mx-auto p-4 pt-20 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div>
            <h2 className="text-2xl font-semibold">{contentData.name}</h2>
          ...
          <DetailImageSlider images={imagesDetailWisata} />
