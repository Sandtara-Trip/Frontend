      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Pembayaran Gagal</h2>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Maaf, terjadi kesalahan dalam proses pembayaran Anda. Silakan coba lagi atau hubungi admin jika masalah berlanjut.
          </p>
          {orderDetails && (
