...
const TambahHotel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Kirim data ke API
      const response = await axios.post(`${API_BASE_URL}/api/hotels`, submitData, {
        headers: {
      ...
      setError(err.response?.data?.message || err.message || "Terjadi kesalahan saat menambahkan hotel");
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Tambah Hotel</h1>
          <p className="text-sm text-gray-600 mt-1">Tambahkan hotel baru ke dalam sistem</p>
        </div>
      </div>
